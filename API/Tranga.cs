...
public static class Tranga
{
    ...
    internal static readonly MangaConnector[] MangaConnectors = [new Global(), new AsuraComic(), new MangaDex(), new Mangaworld(), new WeebCentral(), new ReLibrary(), new KatReadingCafe(), new JNovels(), new BotiTranslation()];
